...
**Версія:** `v4.7.2` (Safe Docker Mode)
...
2. **Скопіюйте** ПОВНИЙ код скрипту `v4.7.2` (`install.sh`) у буфер обміну.
...
1. 🐳 Встановить **Docker**, **Fail2Ban**, **NFTables**.
...
**Репозиторій:** `weby-homelab/voip-installer`
