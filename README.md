...
>
> 💡 Якщо вам потрібно безпечно змінити стандартний порт SSH перед або після встановлення, ви можете скористатися нашою утилітою:
> * **[Інструкція з налаштування SSH-порту (Українська)](https://github.com/weby-homelab/voip-installer/blob/main/tools/ssh-port-changer/README.md)**
