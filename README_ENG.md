Вот красиво оформленная версия твоего руководства. Я использовал Markdown для выделения кода, команд и важных заметок, чтобы документ легко читался.
...
2. **Copy** the FULL code of script `v4.6.2` (`install_eng.sh`) to your clipboard.
