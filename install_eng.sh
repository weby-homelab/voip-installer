...
# ============================================================ 
# VoIP Server Installer v4.6.2 (ENG)
...
Usage:
  ./install_eng.sh --domain example.com [--email you@example.com] [--ext-ip 1.2.3.4] [--tz Europe/Kyiv] [--update] [--yes] 

Options:
  --domain        FQDN (required)
  --email         for Let's Encrypt (required if no certs exist)
  --ext-ip        Explicit external IPv4 (optional, auto-detected if missing)
  --tz            Timezone (default: Europe/Kyiv)
  --update        Update configs + restart
