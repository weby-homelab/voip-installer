...
### Maintenance
- **Docs:** Updated installation instructions to be version-agnostic (generic "copy script" step).
- **Tooling:** Improved `release.sh` to strictly synchronize version numbers across all files (`install.sh`, READMEs).
- **Note:** No functional changes to `install.sh` logic compared to v4.7.6.
